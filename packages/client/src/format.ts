...
const EXTENSION_MAP: Record<string, FormatInfo> = {
  ...
  // Z-machine
  '.z1': { format: 'zcode', interpreter: 'bocfel', isBlorb: false },
  '.z2': { format: 'zcode', interpreter: 'bocfel', isBlorb: false },
  '.z3': { format: 'zcode', interpreter: 'bocfel', isBlorb: false },
  '.z4': { format: 'zcode', interpreter: 'bocfel', isBlorb: false },
  '.z5': { format: 'zcode', interpreter: 'bocfel', isBlorb: false },
  '.z6': { format: 'zcode', interpreter: 'bocfel', isBlorb: false },
  '.z7': { format: 'zcode', interpreter: 'bocfel', isBlorb: false },
  '.z8': { format: 'zcode', interpreter: 'bocfel', isBlorb: false },
  '.zblorb': { format: 'zcode', interpreter: 'bocfel', isBlorb: true },
...
const MAGIC_SIGNATURES: Array<{
  ...
  { bytes: [0x01], offset: 0, format: 'zcode', interpreter: 'bocfel' },
  { bytes: [0x02], offset: 0, format: 'zcode', interpreter: 'bocfel' },
  { bytes: [0x03], offset: 0, format: 'zcode', interpreter: 'bocfel' },
  { bytes: [0x04], offset: 0, format: 'zcode', interpreter: 'bocfel' },
  { bytes: [0x05], offset: 0, format: 'zcode', interpreter: 'bocfel' },
  { bytes: [0x06], offset: 0, format: 'zcode', interpreter: 'bocfel' },
  { bytes: [0x07], offset: 0, format: 'zcode', interpreter: 'bocfel' },
  { bytes: [0x08], offset: 0, format: 'zcode', interpreter: 'bocfel' },
...
function detectBlorbExecutableType(
  ...
  while (pos < totalLength) {
    ...
    if (chunkType === 0x5a434f44) {
      // ZCOD
      return { format: 'zcode', interpreter: 'bocfel' };
    }
